...
return [
    ...
    */
    ...
    'bulk_upload' => 'Bulk Upload',
  	...
  	'success_upload_photos' => 'Template have been successfully uploaded!|Templates have been successfully uploaded!',
  	'go_to_photos' => 'Go to Templates',
  	...
  	'max_files_upload_limit' => 'IMPORTANT: You can upload a maximum of :post_size among all files and  a maximum of (:max_file_uploads) files at the same time',
		'photo_dimensions' => 'The template you selected does not have the valid dimensions (width) :min_width px (height) :min_height px.',
		'photo_mimes' => "The templates must be a file of type: :values.",
